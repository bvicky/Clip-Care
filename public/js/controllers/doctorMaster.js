app.controller('doctorMasterController', function($scope, $http) {
    ...
    $scope.sameAddress = function() {
        ...
        if ($scope.doctor.sameCurrentaddress == false) {
            ...
            console.log($scope.doctor.sameCurrentaddress);
            console.log($scope.doctor.current.landMark);
            //$scope.doctor.current.landMark = $scope.doctor.current.landMark;
        }
        if ($scope.doctor.sameCurrentaddress == true) {
            ...
            $scope.doctor.permanent.landMark = $scope.doctor.current.landMark[0].long_name + ", " + $scope.doctor.current.landMark[addrlength - 5].long_name + ", " + $scope.doctor.current.landMark[addrlength - 3].long_name + ", " + $scope.doctor.current.landMark[addrlength - 2].long_name;
            //$scope.doctor.current.landMark[addrlength-6].long_name + ", " + $scope.doctor.current.landMark[addrlength-5].long_name;
        }
    };
    ...
    $scope.calcMaxSlots = function(){
        for(i=0; i< $scope.doctor.shift.length; i++){
            // console.log(moment($scope.doctor.shift[i].workFrom));
            // console.log($scope.doctor.shift[i].workTo);
            // console.log($scope.doctor.sessionDuration);
